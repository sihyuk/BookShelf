...
public class GalleryAdapter extends RecyclerView.Adapter<GalleryAdapter.MyViewHolder> {
    ...
    private GalleryAdapter.OnMyItemClickListner3 listener;

    public GalleryAdapter(Context context,List<ModelItem> modelItems, OnMyItemClickListner3 listener){
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new GalleryAdapter.MyViewHolder(view, context);
    }
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                listener.setOnItemClickListener3(modelItem, position);
            }
        });
    }
    ...
    public interface OnMyItemClickListner3 {

        void setOnItemClickListener3(ModelItem modelItem, int position);
    }
