...
public class MainActivity extends AppCompatActivity
    ...
    public  void RecentlyAddedBooks(){
        ...
        RecentlyAddedAdapter recyclerViewAdapter = new RecentlyAddedAdapter(this, getdata2(),this);
...
//        intent.putExtra("model", modelItem);
    ...
    public void setOnItemClickListener2(ModelItem modelItem, int position) {
//        Intent intent = new Intent(this, DetailItemActivity.class);
//        intent.putExtra("model", modelItem);
